...
interface Props {
  ...
  updateLigandOrReceptor: (ligandOptions: ColumnBrowserProps[], receptorOptions: ColumnBrowserProps[]) => void;
...
export const ColumnBrowserGroup = (props: Props) => (
  <Card.Group centered doubling stackable>
    <ColumnBrowser
      ...
      updateOptions={(value) => props.updateLigandOrReceptor(value, props.receptorOptions)}
    />
    <ColumnBrowser
      title="Receptor"
      options={props.receptorOptions}
      updateOptions={(value) => props.updateLigandOrReceptor(props.ligandOptions, value)}
    />
    <ColumnBrowser
      title="Pairs"
